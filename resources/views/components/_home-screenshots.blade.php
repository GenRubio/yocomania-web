        ...
        <div class="container" style="background-color: #c6481d;color:white">
            ...
            <div class="row">
                ...
                <div class="col col-lg-10">
                    <h4>
                        <strong>
                            Yocomania World: imagenes publicadas por nuestros jugadores con los momentos mas
                            divertidos.<br> Puedes publicar imagenes desde el panel de usuario.
                        </strong>
                    </h4>
                </div>
            </div>
            <hr style="border-top: 1px dashed white">
            @include('components.screenshots.screenshot')
            <br>
            <div class="d-flex justify-content-center">
