<div class="container shadow-lg rounded" style="background-color: white;">
    ...
    <div class="d-flex justify-content-center">
        <p>Presiona sobre un objeto para subastarlo, venderlo o ver su información.</p>
    </div>
</div>
<br>
<div class="container shadow-lg rounded" style="background-color: white;">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div id="sessesObject{{ $objeto->objeto_id }}" class="alert alert-success" role="alert">
                            </div>
                            <span id="errorObject{{ $objeto->objeto_id }}" style="color:red" class="help-block"></span>
                            <div class="text-left">
                        ...
                        <div class="p-1">
                            <nav>
                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                    <a class="nav-item nav-link active" id="nav-vender{{ $objeto->objeto_id }}-tab"
                                        data-toggle="tab" href="#nav-vender{{ $objeto->objeto_id }}" role="tab"
                                    ...
                                    <a class="nav-item nav-link" id="nav-subastar{{ $objeto->objeto_id }}-tab"
                                        data-toggle="tab" href="#nav-subastar{{ $objeto->objeto_id }}" role="tab"
                                        aria-controls="nav-subastar{{ $objeto->objeto_id }}"
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                ...
                                <div class="tab-pane fade" id="nav-subastar{{ $objeto->objeto_id }}" role="tabpanel"
                                    aria-labelledby="nav-subastar{{ $objeto->objeto_id }}-tab">...</div>
                        ...
                        $.ajax({
                            ...
                            error: function(error) {
                                if (error.responseJSON.errors.ventaOro) {
                                    $("#errorObject{{ $objeto->objeto_id }}").text(error
                                            .responseJSON.errors
                                            .ventaOro)
                                        .fadeIn();
                                }
