<div class="row ml-0 mr-0">
    <div class="col col-lg-8 shadow-lg"
        ...
        <div class="container px-md-5" style="background-color: #c6481d;color:white">
            <br>
            <h1><strong>Consigue créditos ahora y diviértete el doble!</strong></h1>
            <br>
            <div class="row">
                <div class="col-8">
                    <div class="row">
                        ...
                        <div class="col-10">
                            <h4>
                                <strong>
                                    ¿Puedo jugar sin créditos?<br>
                                    ¡Acceder a Yocomania es gratuito! Puedes crear tu
                                    personaje, y jugar todo el tiempo que desees de forma gratuita.
                                </strong>
                            </h4>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-10">
                            <h4>
                                <strong>
                                    ¿Para qué sirven entonces los créditos?<br> 
                                    Acciones como lanzar cocos y usar el guante
                                    de boxeo, o decorar tu isla con objetos... todas necesitan créditos.
                                </strong>
                            </h4>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-10">
                            <h4>
                                <strong>
                                    ¿Cómo consigo créditos?<br>
                                    Puedes comprar créditos desde cualquier país con un teléfono móvil o normal, con una
                                    tarjeta de crédito, o mediante transferencia.
                                </strong>
                            </h4>
                        </div>
                    </div>
                ...
                <div class="col align-self-end">
                    <!-- canvas image -->
                    <img src="{{ url('/images/homeSVG/gataCreditos.svg') }}"
                    height="210",
                    width="170">
                </div>
            </div>
