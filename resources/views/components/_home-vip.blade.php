<div class="row ml-0 mr-0">
    <div class="col col-lg-8 shadow-lg"
        ...
        <div class="container px-md-5" style="background-color: #c6481d;color:white">
            <br>
            <h1><strong>Hazte VIP y disfruta de estas ventajas y regalos cada mes:</strong></h1>
            <br>
            <div class="row">
                <div class="col-8">
                    <div class="row">
                        ...
                        <div class="col-10">
                            <h4>
                                <strong>
                                    Puedes convertirte en VIP en Yocomania pagando una cantidad de Créditos mensual.
                    ...
                    <div class="row">
                        ...
                        <div class="col-10">
                            <h4>
                                <strong>
                                    ¡Podrás personalizar la apariencia de tu casita con muchos más modelos exclusivos!
                                </strong>
                            </h4>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-10">
                            <h4>
                                <strong>
                                    ¡Cada mes te regalaremos un nuevo objeto Rare no disponible en el catálogo!
                                </strong>
                            </h4>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-10">
                            <h4>
                                <strong>
                                    ¡Accede a muchos objetos del catálogo exclusivos para VIP!
                                </strong>
                            </h4>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-10">
                            <h4>
                                <strong>
                                    Amplia tu Pad de amigos hasta un máximo de 300
                                </strong>
                            </h4>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-10">
                            <h4>
                                <strong>
                                    ¿¡A qué esperas!? ¡Entra en Yocomania para hacerte VIP!
                                </strong>
                            </h4>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-10">
                            <h4>
                                <strong>
                                    ¡Recibirás un pack de 8 objetos al hacerte VIP que solo pueden conseguirse de este modo!
                                </strong>
                            </h4>
                        </div>
                    </div>
                ...
                <div class="col align-self-end">
                    <!-- canvas image -->
                    <img src="{{ url('/images/homeSVG/mafiosoVip.svg') }}"
                    height="210",
                    width="170">
                </div>
            </div>
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner rounded shadow-lg p-1 bg-white">
                    <div class="carousel-item active">
                        <img class="d-block w-100" src="{{ url('/images/publicidad1.jpg') }}" alt="First slide"
                            height="350px">
                        <div class="carousel-caption d-none d-md-block">
                            <h4 style="color: white">
                                <strong>
                                    Conoce a gente y haz amigos, como nunca imaginaste
                                </strong>
                            </h4>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-100" src="{{ url('/images/publicidad2.jpg') }}" alt="Second slide"
                            height="350px">
                        <div class="carousel-caption d-none d-md-block">
                            <h4 style="color: white">
                                <strong>
                                    Encuentra tu amor virtual
                                </strong>
                            </h4>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-100" src="{{ url('/images/publicidad3.jpg') }}" alt="Third slide"
                            height="350px">
                        <div class="carousel-caption d-none d-md-block">
                            <h4 style="color: white">
                                <strong>
                                    Reúnete con tu pandilla y comprate la diversión
                                </strong>
                            </h4>
                        </div>
                    </div>
